...
class Main {
    static void display(LinkedList<Employee> al) {
        System.out.println("\n--------------Employee List---------------\n");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            f = new File("C:/Users/adeen/Desktop/EmployeeManagment.txt");
            if (f.exists()) {
                fis = new FileInputStream(f);
                ois = new ObjectInputStream(fis);
                al = (LinkedList<Employee>) ois.readObject();
            }
        ...
        do {
            ...
            do{
                ...
                System.out.println("ENTER KEY TO VERIFY ");
                identity = s1.nextInt();
            }
            while(passWord != identity);
            ...
            switch (ch) {
                ...
                case 2:
                    ...
                    System.out.println("11). Search by ID\n" +
                                    "12). Search by Salary\n"
                            //+ "13). Search by Name\n"
                    );
